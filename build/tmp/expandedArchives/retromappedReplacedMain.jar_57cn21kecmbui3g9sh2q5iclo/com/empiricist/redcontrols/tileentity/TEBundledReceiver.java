...
public class TEBundledReceiver extends TileEntity implements IBundledUpdatable, IConnectable, IBundledTile, IBundledReceiver{ //, IBundledDevice, IRedstoneConnectable} {
    ...
    public void onBundledInputChanged() {
        ...
        for( EnumFacing dir : EnumFacing.values() ){
            ...
            TileEntity te = field_145850_b.func_175625_s( field_174879_c.func_177972_a(dir) );
            if(te == null ){continue;}
            ...
            if(te instanceof TEBundledEmitter){
                for( int i = -1; i < 6; i++ ){
                    in = maxSignal(in, ((TEBundledEmitter) te).getBundledCableStrength(i, dir.func_176734_d().ordinal()));
                }
            }
            if(Loader.isModLoaded("RedLogic") && te instanceof mods.immibis.redlogic.api.wiring.IBundledEmitter){
                ...
                for( int i = -1; i < 6; i++ ){
                    ...
                    in = maxSignal(in, ((mods.immibis.redlogic.api.wiring.IBundledEmitter) te).getBundledCableStrength(i, dir.func_176734_d().ordinal()));
            }
            ...
            if(Loader.isModLoaded("ProjRed|Core") ){//&& te instanceof mrtjp.projectred.api.IBundledEmitter){
                ...
                in = maxSignal(in, ProjectRedAPI.transmissionAPI.getBundledInput(field_145850_b, field_174879_c.func_177958_n(), field_174879_c.func_177956_o(), field_174879_c.func_177952_p(), dir.ordinal()));
                //if(!worldObj.isRemote){LogHelper.info(" " + debugOutput(in));}
            }
...
//                }
            ...
            if(Loader.isModLoaded("ComputerCraft")){
                int ccSignal = ComputerCraftAPI.getBundledRedstoneOutput(field_145850_b, field_174879_c.func_177972_a(dir), dir.func_176734_d());
...
//            }
    ...
    public Packet func_145844_m()
    {
        ...
        return new S35PacketUpdateTileEntity(this.field_174879_c, 1, syncData);
    }
